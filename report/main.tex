...
\begin{itemize}
  \item Primary data source: \path{mvp_temperature_logger/max4466_pressure_map_logger_complete_data/mode_shape/analysis_6freq_filled_ideal/mode_shape_6freq_filled_normalized_summary.csv}.
  \item Fit parameter source: \path{ideal_reference_fit_parameters.csv} in the same folder.
  \item Fixed-position sweep source: \path{mvp_temperature_logger/max4466_pressure_map_logger/data/pressure_sweep/frequency_response_summary.csv}.
  \item Figure source for this portable LaTeX folder: \path{figures/}.
  \item Historical folder names containing \texttt{max4466} are retained as path labels only. Current reporting language uses KY-037 or microphone sound detection sensor.
\end{itemize}
