...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.96\linewidth]{setup_annotated.jpg}
  \caption{Annotated full experimental setup. The loudspeaker on the left drives the acrylic tube. The blocked end board, movable KY-037 microphone probe, beads, and laptop/Python logger form the measurement side of the apparatus.}
  \label{fig:annotated-full-setup}
\end{figure}

\begin{figure}[H]
  \centering
  \begin{subfigure}{0.47\linewidth}
    \includegraphics[width=\linewidth]{subwoofer_annotated.jpg}
    \caption{Loudspeaker driver used to excite acoustic waves in the tube.}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.47\linewidth}
    \includegraphics[width=\linewidth]{amplifier_annotated.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\linewidth]{frequency_response_x37p5_annotated.png}
...
The data files, figure files, and processing scripts used for this report are archived in the GitHub repository:
\url{https://github.com/Yuan1z0825/standing-wave-mode-mapping-data}.

The exact data archive version used for this report is commit \texttt{923c7f5b6d627e8ff08627e519587c00f4057b08}.

\begin{itemize}
  \item Primary mode-shape data: \path{data/mode_shape/mode_shape_6freq_filled_normalized_summary.csv}.
  \item Row-normalized heatmap table: \path{data/mode_shape/mode_shape_6freq_filled_heatmap_row_normalized_table.csv}.
  ...
  \item Historical folder names containing \texttt{max4466} are retained only as path labels. Current reporting language uses KY-037 or microphone sound detection sensor.
\end{itemize}
